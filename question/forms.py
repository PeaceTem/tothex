...
class NewFourChoicesQuestionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ('user', 'quiz', 'is_active','views', 'form', 'index', 'views', 'date_created', 'standalone', 'categories', 'attempts', 'avgScore',  'solution_quality', 'solution_validators', 'answer1NumberOfTimesTaken', 'answer2NumberOfTimesTaken', 'answer3NumberOfTimesTaken', 'answer4NumberOfTimesTaken', 'relevance',)
...
class NewTrueOrFalseQuestionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ('user', 'quiz', 'is_active','views', 'form', 'index', 'views', 'answer1', 'answer2', 'standalone', 'categories', 'solution_validators' , 'date_created', 'categories', 'attempts', 'avgScore',  'solution_quality', 'solution_validators', 'answer1NumberOfTimesTaken', 'answer2NumberOfTimesTaken', 'relevance',)
