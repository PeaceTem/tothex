...
class FourChoicesQuestion(models.Model):
    ...
    question_image = models.ImageField(upload_to='images/fourChoicesQuestion/', null=True, blank=True)
    ...
    solution_image = models.ImageField(upload_to='images/fourChoicesQuestion/solution/', null=True, blank=True)
    ...
    age_to = models.PositiveSmallIntegerField(default=65, choices=AGE_TO_DURATION, verbose_name=_('Maximum Age Of Quiz Takers'))
...
class TrueOrFalseQuestion(models.Model):
    ...
    index = models.PositiveSmallIntegerField(default=0)
    question = RichTextField(max_length=1000, verbose_name=_('Question'))
    question_image = models.ImageField(upload_to='images/trueOrFalseQuestion/', null=True, blank=True)
    date_created = models.DateTimeField(auto_now_add=True)
    date_updated = models.DateTimeField(auto_now=True)
    is_active = models.BooleanField(default=True)
    ...
    solution = RichTextField(max_length=1000, null=True, blank=True, verbose_name=_('Solution'))
    solution_image = models.ImageField(upload_to='images/trueOrFalseQuestion/solution/', null=True, blank=True)
    duration_in_seconds = models.PositiveSmallIntegerField(choices=DURATION_CHOICES, default=30, verbose_name=_('Duration In Seconds'))
